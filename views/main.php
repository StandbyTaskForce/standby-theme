...
<div id="main" class="clearingfix">
    ...
    <div id="threesteps">
      <div class="step">
        <h2 class="info">What is this?</h2>
        <p>On {date/time} there was a {disaster} in {location}. This is a <strong>disaster response map</strong> for people to share information and help each other. It is <strong>not emergency services</strong></p>
      </div>
      <div class="step">
        <h2 class="submit">Submit a report</h2>
        <p>Submitting a report helps others identify hazards/solutions in your area.</p>
        <!-- submit incident -->
        <div class="submit-incident"><a href="http://2.0.ush.crimson.net.nz/reports/submit/">Submit a Report</a></div>
        <!-- / submit incident -->
      </div>
      <div class="step">
        <h2 class="help">Emergency?</h2>
        <p>We are not emergency responders. Please contact your closest Emergency Services.</p>
        <div class="emergency-services">Call 111</div>
      </div>
    </div>
